const name=["易煜轩","蔡孜烨","曹子涵","陈欣怡","陈娅芩","程心壕","戴瑞新","杜新宇","范诗雨","方熠惠","冯勇棋","何诗雯","贺子著","洪承翛","黄梓诚","黄梓昇","李柏毅","李鑫宇","李育泽","刘家怡","刘瑞丰","罗康豫","马世豪","邱蕴霓","童可芯","汪嘉俊","汪子坤","王瑽","王海珊","王梓津","吴博文","吴添愉","肖宇希","谢宏宇","谢佳颖","徐搏铠","徐子谦","杨宸萌","杨鸿钊","杨自成","易淳林","包斯敏","尹元","喻文杰","詹瑞豪","张灿","张文佳","张芸曦","张昕言","周佳怡","周金","朱静秋","朱伦钰","邹文睿","夏明俊","吴紫凡"];
const star=[4,3,3,5,4,4,3,5,4,4,5,3,5,4,3,3,3,3,3,3,3,5,3,3,3,3,3,4,3,3,3,5,3,3,3,3,3,3,3,3,5,3,3,5,3,3,3,4,3,5,3,4,4,3,3,3];
const maxHistory = 15;
const version = 3;
//配置文件编辑器：
