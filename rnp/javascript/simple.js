...
function openURL(URL, IsInPresentWindow) { let link_a = document.createElement("a"); if (IsInPresentWindow != undefined) { link_a.target = "_self"; } else { link_a.target = "_blank"; }; link_a.href = URL; link_a.click(); };
